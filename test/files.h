...
Test_Files(
) {
    {
    	String s_file;
    	String s_extension;
    	String_Append(&s_file, S("C:/test.cpp"));
    	String_Append(&s_extension, S(".cpp|.h"));
...

    {
    	...
    	String s_extension;
    	String_Append(&s_file, S("C:/test.cpp"));
    	String_Append(&s_extension, S(".cp|.h"));
...

    {
		...
		String_Append(&s_pathfile, S(__FILE__));
		String_Replace(&s_pathfile, S("\\"), S("/"));

		if (String_FindRev(&s_pathfile, S("/"), &pos_found)) {
			String s_path;
    ...
    {
    	String s_filename;
    	String_Append(&s_filename, S(__FILE__));
